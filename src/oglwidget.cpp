...
OGLWidget::OGLWidget(QWidget* parent)
        : QOpenGLWidget(parent), m_texture(nullptr), m_program(nullptr), m_ship_vbo(nullptr), m_circle_vbo(nullptr)
        , m_vao(
                nullptr), m_eye(0, 0, 20), rotation(M_PI * 0.5), m_uniformsDirty(true) {
